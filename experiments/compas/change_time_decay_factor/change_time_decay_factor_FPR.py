...
## alpha = 1
(DFMonitor1, uf_list_DF1, fpr_list_DF1, counter_list_TN_DF1,
 counter_list_FP_DF1) = workload.traverse_data_DFMonitor(data, date_column,
                                                         time_window_str,
                                                         monitored_groups,
                                                         threshold,
                                                         1)
black_time_decay_dif_alpha.append([x[1] for x in fpr_list_DF1])
...
print("black_time_decay_dif_alpha", len(black_time_decay_dif_alpha))

with open("FPR_time_decay_factor.csv", "w", newline='') as csvfile:
...
#     f.write("alpha\tblack_time_decay\tblack_traditional\twhite_time_decay\twhite_traditional\thispanic_time_decay\thispanic_traditional\n")
#     for i in range(0, len(black_time_decay_dif_alpha)):
#         print("i = ", i)
#         f.write(str(alpha_list[i]) + "\t" + str(black_time_decay_dif_alpha[i]) + "\t" + str(black_traditional[i]) + "\t"
#                 + str(white_time_decay_dif_alpha[i]) + "\t" + str(white_traditional[i]) + "\t"
...
#
# for i in range(len(alpha_list)):
#     ax[0].plot(x_list, black_time_decay_dif_alpha[i], linewidth=3, markersize=6,
...
# plt.savefig("FPR_time_decay_factor_black.png", bbox_inches='tight')
# plt.show()
#
#
# ############################################## white ####################################################
...
#            ncol=4, labelspacing=0.3, handletextpad=0.3, markerscale=1.6,
#            columnspacing=0.4, borderpad=0.2, frameon=True, handles=handles, labels=labels)
# plt.savefig("FPR_time_decay_factor_white.png", bbox_inches='tight')
# plt.show()
#
# ############################################## hispanic ####################################################
# #
