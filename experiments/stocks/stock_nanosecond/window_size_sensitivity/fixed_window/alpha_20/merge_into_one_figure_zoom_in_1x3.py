...
window_size_units_list = [8000, 20000, 70000]
...
axes[0].set_yticks([0.4, 0.6, 0.8], [0.4, 0.6, 0.8], fontsize=14)
axes[1].set_yticks([0.4, 0.6, 0.8], [0.4, 0.6, 0.8], fontsize=14)
axes[2].set_yticks([0.4, 0.6, 0.8], [0.4, 0.6, 0.8], fontsize=14)
...
leg = axes[0].legend(loc="upper left", fontsize=14,
                bbox_to_anchor=(0, 1.42), ncol=3,
                labelspacing=0.5, draggable=True,
                handletextpad=0.5, markerscale=25, handlelength=1.2, handleheight=0.5,
...
fig.savefig(f"compare_accuracy_time_decay_alpha_{get_integer(alpha)}_fixed_window_change_window_size_zoom_in_{time_start_picture}---{time_end_picture}.png")
plt.show()