...
decay_rate_stocks_removal = 7
decay_function = "exponential_decay"
data_stream = pd.read_csv(f'../{decay_function}_filtered_data_decay_rate_{decay_rate_stocks_removal}.csv')
...
result_file_name = f"prediction_result_end2end_HAT_window_{window_size_units}_remove_stocks_w_expo_decay_rate_{decay_rate_stocks_removal}.csv"
