...
decay_rate_stocks_remove = 8
# Prepare the result file for writing
data_file_name = f"prediction_result_end2end_HAT_window_10_remove_stocks_w_expo_decay_rate_{decay_rate_stocks_remove}.csv"
...
plt.savefig(f"StockAcc_end2end_HAT_alpha_{get_integer(alpha)}_remove_w_expo_decay_rate_{decay_rate_stocks_remove}.png",
            bbox_inches='tight')
plt.show()
