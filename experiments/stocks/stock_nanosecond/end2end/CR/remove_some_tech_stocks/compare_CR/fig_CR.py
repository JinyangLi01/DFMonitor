...
CR_expotential_8 = pd.read_csv("dynamic_CR_exponential_decay_ecay_rate_8_alpha_9997.csv")
CR_expotential_9 = pd.read_csv("dynamic_CR_exponential_decay_ecay_rate_9_alpha_9997.csv")
CR_linear_8 = pd.read_csv("dynamic_CR_linear_decay_ecay_rate_8_alpha_9997.csv")
CR_linear_9 = pd.read_csv("dynamic_CR_linear_decay_ecay_rate_9_alpha_9997.csv")
...
labels = ["Original", "Exponential 8", "Exponential 9", "Linear 8", "Linear 9"]
