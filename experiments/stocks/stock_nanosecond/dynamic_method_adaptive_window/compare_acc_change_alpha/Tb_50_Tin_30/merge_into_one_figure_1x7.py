...
alpha_list = [0.999, 0.9995, 0.9997, 0.9999, 0.99995, 0.99999, 0.999999]
...
fig, axes = plt.subplots(1, 7, figsize=(14.6, 1.7))
plt.subplots_adjust(top=0.82, bottom=0.32, hspace=0, wspace=0.34, left=0.03, right=0.99)
...
axes[0].set_yticks([0.1, 0.5, 0.8], ["0.1", "0.5", "0.8"], fontsize=15)
axes[1].set_yticks([0.1, 0.5, 0.8], ["0.1", "0.5", "0.8"], fontsize=15)
axes[2].set_yticks([0.3, 0.5, 0.8], ["0.3", "0.5", "0.8"], fontsize=15)
axes[3].set_yticks([0.4, 0.5, 0.6, 0.7], ['0.4', '0.5', '0.6', '0.7'], fontsize=15)
axes[4].set_yticks([0.5, 0.6, 0.7], ['0.5', '0.6', '0.7'], fontsize=15)
axes[5].set_yticks([0.55, 0.60, 0.65, 0.7], ['0.55', '0.60', '0.65', '0.70'], fontsize=15)
axes[6].set_yticks([0.55, 0.60, 0.65, 0.7], ['0.55', '0.60', '0.65', '0.70'], fontsize=15)
...
x = fig.legend(handles, labels, loc="upper left", fontsize=16,
                bbox_to_anchor=(0, 1.09), ncol=7,
                labelspacing=0.4, draggable=True,
                handletextpad=0.4, markerscale=80, handlelength=1.2, handleheight=1,
