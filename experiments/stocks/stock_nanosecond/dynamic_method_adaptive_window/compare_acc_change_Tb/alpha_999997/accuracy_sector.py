...
plt.savefig(f"Stock_acc_time_decay_sector_{date}_{time_period}_alpha_{str(get_integer(alpha))}"
            f"_time_unit_{time_unit}*_check_interval_{checking_interval}_Tin_{Tin}_Tb_{Tb}.png", bbox_inches='tight')
plt.show()
