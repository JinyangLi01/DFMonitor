...
for a, Tb in enumerate(Tb_list):
    ...
    axes[a].set_yticks([0.4, 0.6, 0.8], [0.4, 0.6, 0.8], fontsize=14)
...
leg = axes[0].legend(loc="upper left", fontsize=14,
                bbox_to_anchor=(0, 1.49), ncol=7,
                labelspacing=0.5, draggable=True,
                handletextpad=0.5, markerscale=15, handlelength=1.2, handleheight=1,
