...
Tin_list = [10, 50, 100, 500, 1000, 10000]
...
plt.subplots_adjust(top=0.84, bottom=0.32, hspace=0, wspace=0.3, left=0.04, right=0.98)
...
leg = axes[-1].legend(loc="upper left", fontsize=16,
                ...
                handletextpad=0.5, markerscale=14, handlelength=1.2, handleheight=1,
