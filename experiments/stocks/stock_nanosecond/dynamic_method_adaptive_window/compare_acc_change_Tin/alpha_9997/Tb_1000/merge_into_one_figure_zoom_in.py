...
Tin_list = [5, 50, 100, 500, 1000, 5000]
...
plt.subplots_adjust(top=0.84, bottom=0.3, hspace=0, wspace=0.3, left=0.04, right=0.98)
...
axes[0].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
axes[1].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
axes[2].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
axes[3].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
axes[4].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
axes[5].set_yticks([0.4, 0.6, 0.8], ["0.40", "0.60", "0.80"], fontsize=15)
...
leg = axes[-1].legend(loc="upper left", fontsize=16,
                bbox_to_anchor=(-5, 1.43), ncol=7,
                labelspacing=0.5, draggable=True,
                handletextpad=0.2, markerscale=14, handlelength=1.2, handleheight=1,
