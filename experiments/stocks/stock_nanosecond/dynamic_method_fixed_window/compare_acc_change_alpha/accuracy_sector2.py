...
time_end = pd.Timestamp('2024-10-15 14:00:10.005', tz='UTC')
...
CommunicationServices_time_decay = [x[1] for x in accuracy_list]

print(Technology_time_decay)
print(CommunicationServices_time_decay)


filename = (f"stocks_compare_Accuracy_sector_{date}_{time_period}_alpha_{str(get_integer(alpha))}"
            f"_time_unit_{time_unit}*{window_size_units}_check_interval_{checking_interval}_v2.csv")
