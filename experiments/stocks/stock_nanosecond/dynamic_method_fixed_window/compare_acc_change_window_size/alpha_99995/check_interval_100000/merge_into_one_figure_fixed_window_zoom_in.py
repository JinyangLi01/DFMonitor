...
window_size_units_list = [40, 60, 100, 400, 1000, 4000]
...
plt.tight_layout()
fig.savefig(f"compare_accuracy_time_decay_fixed_window_change_window_size_zoom_in_fig_{draw_figure_start_time}_to_{draw_figure_end_time}.png")
plt.show()
