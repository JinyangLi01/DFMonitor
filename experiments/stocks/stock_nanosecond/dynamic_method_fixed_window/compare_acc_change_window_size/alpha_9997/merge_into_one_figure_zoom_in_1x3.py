...
axes[2].set_yticks([0.2, 0.5, 0.8], [0.2, 0.5, 0.8], fontsize=14)
axes[2].set_ylim(0, 1)
...
fig.savefig(f"compare_accuracy_time_decay_fixed_window_change_window_size_zoom_in_{time_start_picture}---{time_end_picture}.png")
plt.show()
