...
with open(filename, "w", newline='') as csvfile:
    ...
    writer.writerow(["Technology_time_decay", "ConsumerCyclical_time_decay",
                     "CommunicationServices_time_decay", "ConsumerDefensive_time_decay",
                     "Energy_time_decay", "Healthcare_time_decay", "FinancialServices_time_decay", "check_points"])
