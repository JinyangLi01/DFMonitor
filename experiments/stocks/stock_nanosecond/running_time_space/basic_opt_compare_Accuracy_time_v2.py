...
time_start = pd.Timestamp('2024-10-15 14:00:05.0', tz='UTC')
time_end = pd.Timestamp('2024-10-15 14:00:06.0', tz='UTC')
...
window_size_units = "1"
checking_interval = "1000000 nanosecond"
use_nanosecond = True
...
with open("running_time_Accuracy_v2.csv", "a", newline='') as csvfile:
