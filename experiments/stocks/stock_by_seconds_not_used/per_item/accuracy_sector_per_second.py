...
exmained_time = "9-14"
data = pd.read_csv('../prediction_result_s&p50_all_stocks_2024-09-18_sorted_with_binary_direction_' + exmained_time + '.csv')
...
filename = f"stocks_compare_Accuracy_{method_name}_sector_per_item_{exmained_time}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}*{window_size_units}_check_interval_{checking_interval}.csv"
