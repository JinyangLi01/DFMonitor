...
##import data
data_set=pd.read_csv("../../../data/movielens/CF_100K/u.data", header=None, sep='\s+').values
...
import os
if os.path.exists("user_similarity_matrix.npy"):
...
def MAE_calculator(predicted_user_rating_array,user_rating_array):
    ...
    # I want to know whether predicted_user_rating_array only has 0 and 1
    unique_values = np.unique(predicted_user_rating_array)
    # print("MAE_calculator, unique values in predicted_user_rating_array: ", unique_values)
