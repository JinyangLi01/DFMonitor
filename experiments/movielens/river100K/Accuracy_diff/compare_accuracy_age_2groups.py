...
monitored_groups = [{"age_2groups": "7-30"}, {"age_2groups": "31-73"}]
print(data[:5])
alpha = 0.5
threshold = 0.3
...
age_7_30_time_decay = [x[0] for x in accuracy_list_DF]
age_7_30_traditional = [x[0] for x in accuracy_list_trad]
age_31_73_time_decay = [x[1] for x in accuracy_list_DF]
age_31_73_traditional = [x[1] for x in accuracy_list_trad]



# save to file

filename = "movielens_compare_Accuracy_" + method_name + "_age_2groups.csv"
with open(filename, "w", newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(["age_7_30_time_decay", "age_7_30_traditional", "age_31_73_time_decay", "age_31_73_traditional"])
    for i in range(len(age_7_30_traditional)):
        writer.writerow([age_7_30_time_decay[i], age_7_30_traditional[i],
                         age_31_73_time_decay[i], age_31_73_traditional[i]])
