...
df = pd.read_csv("movielens_compare_Accuracy_online_cf_time_decay_gender.csv")
print(df)
...
plt.savefig("Acc_online_cf_time_decay_traditional_gender.png", bbox_inches='tight')
plt.show()