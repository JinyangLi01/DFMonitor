...
axs[0][0].plot(x_list, df_adaptive["male_time_decay"], linewidth=1.5, markersize=2.5, label='male dynamic',
            linestyle='-', marker='o',
            color=curve_colors[2])
axs[1][0].plot(x_list, df_adaptive["female_time_decay"], linewidth=1.5, markersize=2.5, label='female dynamic',
            linestyle='-', marker='o',
...
print("len of df_traditional: ", len(df_traditional))
...
def plot_certain_time_window(df, value_col_name, window_size, axs):
    ...
    axs[0][0].plot(np.arange(len(male_lst)), male_lst, linewidth=1.5, markersize=2,
             label="male traditional", linestyle='--', marker='o', color=curve_colors[4])
    axs[1][0].plot(np.arange(len(female_lst)), female_lst, linewidth=1.5, markersize=2,
             label='female traditional', linestyle='--', marker='o', color=curve_colors[5])
...
desired_order = [0, 1,  2, 3 ]  # Reorder as needed
...
axs[0][0].legend(reordered_handles, reordered_labels, title_fontsize=14, loc='upper left',
                 ...
                 fontsize=13, ncol=2, labelspacing=0.2, handletextpad=0.4, markerscale=1,
                 columnspacing=0.8, borderpad=0.2, frameon=False)

fig.savefig("curves_slides_adaptive.png", bbox_inches='tight')
