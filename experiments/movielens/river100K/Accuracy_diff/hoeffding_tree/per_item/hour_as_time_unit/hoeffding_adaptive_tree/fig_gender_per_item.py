...
df = pd.read_csv("movielens_compare_Accuracy_hoeffding_adaptive_classifier_gender_per_item_50.csv")[:200]
print(df)
...
plt.savefig("Acc_hoeffding_adaptive_tiem_decay_gender_per_item_50.png", bbox_inches='tight')
plt.show()