...
alpha10 = "100"
df = pd.read_csv("movielens_compare_Accuracy_hoeffding_classifier_gender_per_item_alpha_"+alpha10 + ".csv")
print(df)
...
plt.savefig("Acc_hoeffding_timedecay_traditional_gender_per_item_alpha_" + alpha10 + ".png", bbox_inches='tight')
plt.show()