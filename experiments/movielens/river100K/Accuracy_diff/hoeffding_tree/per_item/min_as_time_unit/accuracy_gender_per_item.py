...
filename = f"movielens_compare_Accuracy_{method_name}_gender_per_item_alpha_{str(int(alpha*100))}_time_unit_{time_unit}.csv"
...
df = pd.read_csv(f"movielens_compare_Accuracy_hoeffding_classifier_gender_per_item_alpha_{str(int(alpha*100))}_time_unit_{time_unit}.csv")
print(df)
...
plt.savefig(f"Acc_hoeffding_timedecay_traditional_gender_per_item_alpha_{str(int(alpha*100))}_time_unit_{time_unit}.png", bbox_inches='tight')
plt.show()