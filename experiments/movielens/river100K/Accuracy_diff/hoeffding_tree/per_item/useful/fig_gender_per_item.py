...
alpha = 0.999997
time_unit = "1 min"
df = pd.read_csv(f"movielens_compare_Accuracy_hoeffding_classifier_gender_per_item_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}.csv")
print(df)
...
plt.savefig(f"Acc_hoeffding_timedecay_traditional_gender_per_item_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}.png", bbox_inches='tight')
plt.show()