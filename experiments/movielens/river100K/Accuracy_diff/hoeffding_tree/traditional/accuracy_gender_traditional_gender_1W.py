...
def plot_certain_time_window(window_size, axs):
    ...
    axs.set_xlabel('(b) window size = 1 week', fontsize=14, labelpad=-0.5, fontweight='bold').set_position([0.4, 0])
    ...
    axs.annotate('', xy=(2, y[6]), xytext=(7.3, y[6]),
                  arrowprops=dict(arrowstyle='-', linestyle=":", color='black', lw=1.5),
                 fontsize=12, ha='center')
    plt.text(0.8, 0.62, round(y[5] - y[6], 2), fontsize=11, va='bottom')
    ...
    axs.annotate('', xy=(15, y[18]), xytext=(19, y[18]),
                 arrowprops=dict(arrowstyle='-', linestyle=":", color='black', lw=1.5),
                 fontsize=12, ha='center')
    plt.text(12.3, 0.7, round(y[17] - y[18], 2), fontsize=11, va='bottom')
    ...
    plt.axvline(x=26, color='black', linestyle=(0, (5, 5)), linewidth=1.5, alpha=1)
