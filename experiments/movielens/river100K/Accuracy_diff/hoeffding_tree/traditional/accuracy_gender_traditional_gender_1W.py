...
def plot_certain_time_window(window_size, axs):
    ...
    axs.legend(loc='lower right',
           bbox_to_anchor=(1.0, 0.12),  # Adjust this value (lower the second number)
    ...
    axs.set_xlabel('timestamps, window size = 1 week', fontsize=16)
...
plot_certain_time_window('1W', axs)
