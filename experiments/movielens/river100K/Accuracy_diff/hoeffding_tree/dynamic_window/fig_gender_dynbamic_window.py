...
Tb = 500
Tin = 60
df = pd.read_csv(f"movielens_compare_Accuracy_hoeffding_classifier_gender_dynamic_Tb_{Tb}_Tin_{Tin}_alpha_{alpha10}_time_unit_{time_unit}.csv")
print(df)
...
plt.savefig(f"Acc_hoeffding_time_decay_gender_dynamic_Tb_{Tb}_Tin_{Tin}_alpha_{alpha10}.png", bbox_inches='tight')
plt.show()