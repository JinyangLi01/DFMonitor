...
window_size_unit_list = ['1', '60*60*24', '60*60*24*7', '60*60*24*14', '60*60*24*30', '60*60*24*30*3']

result_file_list = dict()
for window_size in window_size_unit_list:
    if window_size =="1":
        window_size = "1 hour"
    file_name = f"movielens_compare_Accuracy_hoeffding_classifier_gender_per_item_alpha_9999989_time_unit_1 second*{window_size}_check_interval_{window_size}.csv"
...
fig, axs = plt.subplots(1, 6, figsize=(12, 1))
...
axs.flat[2].set_xlabel('(c) 1 week', fontsize=13, labelpad=3, fontweight='bold').set_position([0.4, -0.1])
...
plt.legend(title_fontsize=14, loc='upper left', bbox_to_anchor=(-3.8, 1.4), fontsize=14,
