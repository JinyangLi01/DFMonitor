...
time_unit = "1 second"
window_size_units = "60*60*24*30*3"
...
filename = f"time_window_check_per_day/movielens_compare_Accuracy_{method_name}_gender_per_item_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}*{window_size_units}_check_interval_{checking_interval}.csv"
...
df = pd.read_csv(f"time_window_check_per_day/movielens_compare_Accuracy_hoeffding_classifier_gender_per_item_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}*{window_size_units}_check_interval_{checking_interval}.csv")
print(df)
...
plt.savefig(f"time_window_check_per_day/Acc_hoeffding_timedecay_gender_per_item_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}*{window_size_units}_check_interval_{checking_interval}.png", bbox_inches='tight')
plt.show()