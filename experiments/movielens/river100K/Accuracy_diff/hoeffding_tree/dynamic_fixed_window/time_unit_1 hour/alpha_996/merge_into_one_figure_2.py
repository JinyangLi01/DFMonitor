...
axs.flat[0].set_xlabel('(a) 1 hour', fontsize=15, labelpad=3).set_position([0.4, -0.1])
...
axs.flat[3].set_xlabel('(d) 4 weeks', fontsize=15, labelpad=3).set_position([0.4, -0.1])

# axs.flat[4].set_yscale('symlog', linthresh=0.35)
axs.flat[4].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[4].set_xlabel('(e) 2 months', fontsize=15, labelpad=3).set_position([0.4, -0.1])
...
plt.tight_layout()
plt.savefig("movielens_accuracy_fixed_windows_change_sizes2.png", bbox_inches='tight')
plt.show()
