...
# output the counter list

filename = f"test_counters.csv"
with open(filename, "w", newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(["counter_list_correct", "counter_list_incorrect"])
    for i in range(len(counter_list_correct)):
        writer.writerow([counter_list_correct[i], counter_list_incorrect[i]])
...
df = pd.read_csv(f"test_accuracy.csv")
print(df)
