...
filename = f"movielens_compare_Accuracy_{method_name}_gender_dynamic_Tb_{T_b/eval(window_size_units)}_Tin_{T_in/eval(window_size_units)}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}.csv"
...
df = pd.read_csv(f"movielens_compare_Accuracy_hoeffding_classifier_gender_dynamic_Tb_{T_b/eval(window_size_units)}_Tin_{T_in/eval(window_size_units)}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}.csv")
print(df)
...
plt.savefig(f"Acc_hoeffding_time_decay_gender_dynamic_Tb_{T_b/eval(window_size_units)}_Tin_{T_in/eval(window_size_units)}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}.png", bbox_inches='tight')
plt.show()