...
df = pd.read_csv("explore/movielens_compare_Accuracy_hoeffding_classifier_gender.csv")
print(df)
...
plt.savefig("Acc_hoeffding_timedecay_traditional_gender.png", bbox_inches='tight')
plt.show()