...
filename = f"check_interval_" + checking_interval.replace(" ", "") + f"/movielens_compare_Accuracy_{method_name}_gender_dynamic_Tb_{T_b}_Tin_{T_in}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}_check_interval_{checking_interval}.csv"
print(filename)
...
filename = f"check_interval_" + checking_interval.replace(" ", "") + f"/movielens_dynamic_window_reset_time_Tb_{T_b}_Tin_{T_in}_time_unit_{time_unit}.csv"
with open(filename, "w", newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
...
df = pd.read_csv(f"check_interval_" + checking_interval.replace(" ", "") + f"/movielens_compare_Accuracy_hoeffding_classifier_gender_dynamic_Tb_{T_b}_Tin_{T_in}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}_check_interval_{checking_interval}.csv")
print(df)
...
plt.savefig(f"check_interval_" + checking_interval.replace(" ", "") + f"/Acc_hoeffding_time_decay_gender_dynamic_Tb_{T_b}_Tin_{T_in}_alpha_{str(get_integer(alpha))}_time_unit_{time_unit}_check_interval_{checking_interval}.png", bbox_inches='tight')
plt.show()
