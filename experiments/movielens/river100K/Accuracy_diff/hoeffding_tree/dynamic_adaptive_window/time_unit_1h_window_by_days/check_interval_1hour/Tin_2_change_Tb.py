...
curve_colors = sns.color_palette(palette=['navy', 'blue', 'cornflowerblue', 'lightgreen', '#41ab5d', '#006837', "darkorange"])
...
for T_b in Tb_list:
    ...
    axs.plot(x_list, male_time_decay, linewidth=0.5, markersize=1,
                label='{}'.format(T_b), linestyle='-', marker='o', color=curve_colors[idx])
