...
plt.subplots_adjust(top=0.85, bottom=0, hspace=0, wspace=0.35, left=0.0, right=0.99)
...
axs.flat[0].set_xlabel('(a) 1 day', fontsize=15, labelpad=-2).set_position([0.4, 1])
axs.flat[1].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[1].set_xlabel('(b) 3 days', fontsize=15, labelpad=-2).set_position([0.4, -0.1])
# axs.flat[2].set_yscale('symlog', linthresh=0.22)
axs.flat[2].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[2].set_xlabel('(c) 1 week', fontsize=15, labelpad=-2).set_position([0.4, -0.1])

axs.flat[3].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[3].set_xlabel('(d) 1 month', fontsize=15, labelpad=-2).set_position([0.4, -0.1])

# axs.flat[4].set_yscale('symlog', linthresh=0.35)
axs.flat[4].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[4].set_xlabel('(e) 2 months', fontsize=15, labelpad=-2).set_position([0.4, -0.1])


axs.flat[5].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=15)
axs.flat[5].set_xlabel('(f) 3 months', fontsize=15, labelpad=-2).set_position([0.4, -0.1])
...
x = fig.legend(title_fontsize=14, loc='upper left', bbox_to_anchor=(-0.02, 1.27), fontsize=15,
...
# plt.tight_layout()
plt.savefig("movielens_accuracy_adaptive_windows_change_Tb.png", bbox_inches='tight')
plt.show()
