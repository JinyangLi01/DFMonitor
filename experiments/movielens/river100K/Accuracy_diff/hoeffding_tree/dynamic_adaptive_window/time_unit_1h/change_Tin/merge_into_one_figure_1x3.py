...
plt.subplots_adjust(top=0.85, bottom=0.3, hspace=0, wspace=0.28, left=0.06, right=0.99)
...
for i in range(len(Tin_list)):
    ...
    axs[axis_number[i]].set_yticks([0.6, 0.7, 0.8, 0.9], ['0.6', '0.7', '0.8', '0.9'], fontsize=14)
    xlabel = f"({chr(97 + i)}) $T_{{in}} = {Tin}$"
    axs[axis_number[i]].set_xlabel(xlabel, fontsize=14, labelpad=-2).set_position([0.4, -0.1])
...
plt.savefig("movielens_accuracy_adaptive_windows_change_Tin.png")
plt.show()
