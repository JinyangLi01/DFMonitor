...
for i in range(len(alpha_list)):
    ...
    if i >= 5:
        axs.flat[i].set_ylim(0.7, 0.9)
        axs[axis_number[i]].set_yticks([0.7, 0.8, 0.9], ['0.7', '0.8', '0.9'], fontsize=15)
    else:
        axs.flat[i].set_ylim(0.5, 1.0)
        axs[axis_number[i]].set_yticks([0.6, 0.8, 1.0], ['0.6', '0.8', '1.0'], fontsize=15)
...
# plt.tight_layout()
plt.savefig("movielens_accuracy_adaptive_windows_change_alpha.png", bbox_inches='tight')
plt.show()
