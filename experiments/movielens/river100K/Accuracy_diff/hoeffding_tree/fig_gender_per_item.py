...
df = pd.read_csv("movielens_compare_Accuracy_hoeffding_classifier_gender_per_item.csv")[:200]
print(df)
...
ax.plot(x_list, male_time_decay, linewidth=0.5, markersize=6, label='Male time decay', linestyle='-', marker='o', color=pair_colors[0])
ax.plot(x_list, female_time_decay, linewidth=0.5, markersize=6, label='Female time decay', linestyle='-', marker='o', color=pair_colors[2])
...
plt.savefig("Acc_hoeffding_timedecay_traditional_gender_per_item.png", bbox_inches='tight')
plt.show()