...
uf_list_trad, fnr_list_trad, counter_list_TP_trad, counter_list_FN_trad = workload.FNR_traditional(data, date_column,
                                                                                                   time_window_str,
                                                                                                   monitored_groups,
                                                                                                   threshold,
                                                                                                   label_prediction,
...
plt.savefig("FNR_movielens_age_group_hoeffding_classofier.png", bbox_inches='tight')
plt.show()
