...
with open("baby_names_compare_CR.csv", "w", newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(["year", "male_time_decay", "female_time_decay", "male_traditional", "female_traditional"])
    for i in range(len(years)):
        writer.writerow([years[i], cr_list_DF[i][0], cr_list_DF[i][1], cr_list_trad[i][0], cr_list_trad[i][1]])
